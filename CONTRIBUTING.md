...
- 本仓库是 **opinionated** 的（基于 logic-labs 实践），详见 [docs/opinionated.md](docs/opinionated.md)；大改动前先开 issue 讨论
...
当前仓库只含 `templates/logic-labs-style/`。欢迎新增其他 PRD 风格（Amazon PR-FAQ、Intercom RFC 等）：
